...
local SilentAimSettings = {
    ...
    ClassName = "MateoPixelated Client - mateopixelated",
    ToggleKey = "RightAlt",
...
Library:SetWatermark("MateoPixelated Client")

local Window = Library:CreateWindow({Title = 'MateoPixelated Client', Center = true, AutoShow = true, TabPadding = 8, MenuFadeTime = 0.2})
